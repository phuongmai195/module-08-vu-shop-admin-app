...
public interface UserRepository extends JpaRepository<User, Long> {
	...
	@Query(nativeQuery = true, value = QueryConstant.FIND_USER_FORGOT)
	List<User> findByUserForgot(@Param(ParameterConstant.EMAIL_PARAMETER) String email, @Param(ParameterConstant.NUMBER_PHONE_PARAMETER) String numberPhone );
	
//	Optional<User> findByUserForgot(String email, String numberPhone);
}
